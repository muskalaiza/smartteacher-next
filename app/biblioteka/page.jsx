        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl space-y-3">
            ...
            <p className="text-sm leading-6 text-zinc-400">
              Organizuj zapisane karty pracy, kartkówki i sprawdziany.
              Wracaj do gotowych materiałów, filtruj je według przedmiotu,
              działu i typu pracy.
            </p>
          </div>
      ...
      <section className="rounded-2xl border border-zinc-800 bg-zinc-950/70 p-6 shadow-sm">
        <div className="flex flex-col gap-4 border-b border-zinc-800 pb-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="grid gap-3 sm:grid-cols-3 lg:w-[720px]">
            ...
            >
              <option value="all-subjects">Wszystkie przedmioty</option>
              <option value="informatyka">Informatyka</option>
              <option value="programowanie-obiektowe">
