...
const ASD_ANSWER_HINTS = {
  ...
  error_find:
    "Wpisz poprawiony fragment kodu w wyznaczonym miejscu.",

  open_code:
    "Napisz kod w wyznaczonym miejscu i sprawdź kolejno każde wymaganie.",

  open_explain:
    "Napisz krótkie wyjaśnienie w wyznaczonym miejscu.",
};
