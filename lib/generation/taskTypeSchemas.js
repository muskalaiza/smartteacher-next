...
export const taskTypeSchemas = {
  ...
  error_find: {
    ...
    schema: createTaskSchema("error_find", {
      ...
      codeWithError: textSchema(
         "Czysty kod zawierający dokładnie jeden rzeczywisty i jednoznaczny błąd."
      ),
    ...
    rules: [
  "Błąd musi powodować błąd kompilacji, błędny wynik albo zachowanie sprzeczne z poleceniem.",
  "Nie uznawaj za błąd poprawnej składni, dozwolonej konwersji, alternatywnego poprawnego zapisu ani wyłącznie gorszego stylu kodu.",
  "Pole expectedCode musi usuwać wskazany błąd i różnić się od codeWithError tylko w zakresie potrzebnym do poprawy.",
  ...
  open_explain: {
    description:
      "Zadanie otwarte polegające na samodzielnym wyjaśnieniu mechanizmu.",

    schema: createTaskSchema("open_explain", {
      instruction: textSchema(
        "Samodzielne pytanie określające, jaki mechanizm uczeń ma wyjaśnić. Polecenie nie może zawierać gotowej odpowiedzi."
      ),
    ...
    rules: [
      "Pole instruction musi być samodzielnym pytaniem możliwym do rozwiązania na podstawie źródła i wiedzy sprawdzanej w zadaniu.",
      "Pole instruction nie może zawierać gotowej odpowiedzi, wzorcowego wyjaśnienia ani dodatkowego kontekstu zdradzającego rozwiązanie.",
